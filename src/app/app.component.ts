...
const answer2 = data.reduce<string[]>((acc, curr) => [...acc, curr.email], [])
console.log({answer2});
...
const answer8 = data
  .filter(id => id.website.includes('.com'))
  .map(id => id.website);
console.log({answer8});

const answer9 = data.filter(id => id.username.length > 12)
console.log({answer9});

const answer10 = data.map(id => id.username.toLowerCase())
